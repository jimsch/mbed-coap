...
static int8_t                sn_coap_protocol_store_blockwise_msg_context(struct coap_s *handle, uint16_t payload_len, sn_coap_hdr_s* src_coap_msg_ptr);
#endif
...
static int8_t sn_coap_protocol_store_blockwise_msg_context(struct coap_s *handle,
        uint16_t payload_len, sn_coap_hdr_s* src_coap_msg_ptr)
{
    /* If blockwising needed */
